%token IDENTIFIER LIT_INTEGER LIT_STRING LIT_DOUBLE SIZEOF
%token MULT_OP PLUS_PLUS MINUS_MINUS LEFT_OP RIGHT_OP LE_OP GE_OP EQ_OP NE_OP
...
post_expr
:                   terminal_expr
|                   post_expr MULT_OP IDENTIFIER
|                   post_expr PLUS_PLUS
|                   post_expr MINUS_MINUS
|                   post_expr '[' expression ']'
|                   post_expr '(' ')'
|                   post_expr '(' argument_expression_list ')'
...
additive_expression
	: factor_expr
	| additive_expression '+' factor_expr
	| additive_expression '-' factor_expr
	;
